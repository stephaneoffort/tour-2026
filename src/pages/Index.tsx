        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          ...
          <div className="mb-10 animate-fade-up" style={{ animationDelay: '0.25s' }}>
            ...
            <div className="border border-secondary/25 border-t-2 border-t-secondary px-5 pt-5 pb-3.5 mb-6 bg-navy/[0.07]">
              ...
              <p className="text-[0.82rem] text-bgray/70 mb-5 leading-relaxed">If a physical visit is not possible, please indicate dates for a remote teaching or online connection with your center.</p>
