        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          ...
          <div className="mb-10 animate-fade-up" style={{ animationDelay: '0.25s' }}>
            ...
            <div className="border border-secondary/25 border-t-2 border-t-gold px-5 pt-5 pb-3.5 mb-6 bg-navy/[0.07]">
              ...
              <p className="text-[1.25rem] text-gold-light font-display italic mb-5 tracking-[0.02em]">H.H. Karmapa comes to the Europe Center</p>
            ...
            <div className="grid grid-cols-1 gap-5 mt-5">
              <div className="flex flex-col gap-[7px]">
                <FieldLabel htmlFor="topics">Topic(s) of the course</FieldLabel>
              ...
              <div className="flex flex-col gap-[7px]">
                <FieldLabel htmlFor="empowerments">Request for empowerment(s)</FieldLabel>
